...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        throw_if(
            ! is_array($tableNames) || $tableNames === [],
            Exception::class,
        ...
        throw_if(
            $teams
            && (
                ($columnNames['team_foreign_key'] ?? null) === null
        ...
        Schema::create($tableNames['roles'], static function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('guard_name'); // For MyISAM use string('guard_name', 25);
            $table->timestamps();
            $uniqueKeys = $teams || config('permission.testing')
        ...
        Schema::create($tableNames['model_has_permissions'], static function (Blueprint $table) use (
            ...
            $table->primary($primaryKeys, 'model_has_permissions_permission_model_type_primary');
        });
        ...
        Schema::create($tableNames['model_has_roles'], static function (Blueprint $table) use (
            ...
            $table->primary($primaryKeys, 'model_has_roles_role_model_type_primary');
        });
