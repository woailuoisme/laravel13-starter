...
class ManageSystemSettings extends SettingsPage
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema->components([
            TextInput::make('site_name')->label(__('admin.pages.manage_ecommerce.fields.site_name'))->required(),
            Toggle::make('is_shop_open')->label(__('admin.pages.manage_ecommerce.fields.is_shop_open'))->required(),
            ...
            TagsInput::make('allowed_payment_gateways')
                ...
                ->required(),
            TextInput::make('close_reason')->label(__('admin.pages.manage_ecommerce.fields.close_reason')),
        ]);
    }
}
