...
class AuthFlowService
{
    ...
    public function requestSignin(
        ...
        Cache::put(
            $this->signinCacheKey($challengeToken),
            [
                'user_id' => $user->id,
                'email' => $user->email,
                'requested_ip' => $ip,
    ...
    public function verifySignin(#[SensitiveParameter] string $challengeToken, string $code, ?string $ip): User
    {
    ...
    public function resetPassword(string $email, string $code, #[SensitiveParameter] string $password): void
    {
        ...
        DB::transaction(static function () use ($user, $password, $otp): void {
            $user->forceFill([
    ...
    private function signinCacheKey(#[SensitiveParameter] string $challengeToken): string
    {
